    ...
    public partial class Aluehallinta : ContentPage
    {
        ...
        public async Task PoistaValittuAlue(string alueenNimi)
        {
            ...
            try
            {
                ...
                {
                    await conn.OpenAsync();
                    // Tarkista ensin, onko alueella liittyvi‰ palveluita.
                    ...
                    using (MySqlCommand cmdCheck = new MySqlCommand(checkQuery, conn))
                    {
                        ...
                        if (count > 0)
                        {
                            // Jos liittyvi‰ palveluita on, n‰yt‰ virheilmoitus ja palaa.
                            await DisplayAlert("Poisto ep‰onnistui", $"Aluetta '{alueenNimi}' ei voi poistaa, koska siihen liittyy viel‰ palveluita.", "OK");
                            return;
                        }
                    }

                    // Jos ei ole liittyvi‰ palveluita, jatka poistoon.
            ...
            {
                // Jos yleinen tietokantavirhe tapahtuu, n‰yt‰ yleinen virheilmoitus.
                await DisplayAlert("Tietokantavirhe", $"Aluetta ei voi poistaa: Alueeseen liittyy aktiivisia tai liitettyj‰ varauksia. {ex.Message}", "OK");
            }
        }
    }
}
