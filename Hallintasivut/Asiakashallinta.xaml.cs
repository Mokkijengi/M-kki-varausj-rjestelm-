...
namespace booking_VillageNewbies
{
    public partial class Asiakashallinta : ContentPage
    {
        ...
        private async void LisaaAsiakas_Clicked(object sender, EventArgs e)
        {
            ...
            // Regex-s‰‰nnˆt s‰hkˆpostille ja puhelinnumerolle.
            var emailRegex = new System.Text.RegularExpressions.Regex(@"^\S+@\S+\.\S+$");

            var phoneRegex = new System.Text.RegularExpressions.Regex(@"^\d{10}$");

            // Tarkista ett‰ kaikki pakolliset kent‰t on t‰ytetty.
            ...
            try
            {
                ...
                {
                    await conn.OpenAsync();
                    // Poistettu asiakas_id t‰st‰ kyselyst‰, koska se on AUTO_INCREMENT-kentt‰
                    ...
                    {
                        // Parametrien nimet on korjattu vastaamaan tietokannan kentti‰ ja poistettu asiakas_id
